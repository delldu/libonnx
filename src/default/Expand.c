...
static int Expand_exit(onnx_node_t *n) { return 1; }
...
static void Expand_bool(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Expand_int8(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Expand_int16(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Expand_int32(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Expand_int64(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Expand_uint8(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
  uint8_t *py = (uint8_t *)y->datas;
  uint8_t *px = (uint8_t *)x->datas;
...
static void Expand_uint16(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Expand_uint32(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Expand_uint64(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Expand_float32(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Expand_float64(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
