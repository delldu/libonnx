...
void *resolver_default_create(void) { return NULL; }
...
onnx_resolver_t resolver_default = {
    ...
    .op_MeanVarianceNormalization =
        resolver_default_op_MeanVarianceNormalization,
    .op_NegativeLogLikelihoodLoss =
        resolver_default_op_NegativeLogLikelihoodLoss,
