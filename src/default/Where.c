...
static int Where_exit(onnx_node_t *n) { return 1; }

static int Where_reshape(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  int i;

  if (!onnx_tensor_reshape_identity(y, n->inputs[n->ninput - 1],
                                    n->inputs[n->ninput - 1]->type))
    return 0;
...
static void Where_bool(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
...
static void Where_int8(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
...
static void Where_int16(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
...
static void Where_int32(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
...
static void Where_int64(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
...
static void Where_uint8(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
...
static void Where_uint16(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
...
static void Where_uint32(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
...
static void Where_uint64(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
...
static void Where_float32(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
...
static void Where_float64(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x0 = n->inputs[0];
  onnx_tensor_t *x1 = n->inputs[1];
  onnx_tensor_t *x2 = n->inputs[2];
