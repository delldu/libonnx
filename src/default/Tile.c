...
static int Tile_exit(onnx_node_t *n) { return 1; }
...
static void Tile_bool(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Tile_int8(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Tile_int16(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Tile_int32(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Tile_int64(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Tile_uint8(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
  uint8_t *py = (uint8_t *)y->datas;
  uint8_t *px = (uint8_t *)x->datas;
...
static void Tile_uint16(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Tile_uint32(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Tile_uint64(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Tile_float32(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
...
static void Tile_float64(onnx_node_t *n) {
  onnx_tensor_t *y = n->outputs[0];
  onnx_tensor_t *x = n->inputs[0];
