...
typedef struct Onnx__TensorShapeProto__Dimension
...
typedef enum _Onnx__AttributeProto__AttributeType {
  ...
  ONNX__ATTRIBUTE_PROTO__ATTRIBUTE_TYPE__SPARSE_TENSORS =
      12 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(
          ONNX__ATTRIBUTE_PROTO__ATTRIBUTE_TYPE)
...
typedef enum _Onnx__TensorProto__DataType {
  ...
  ONNX__TENSOR_PROTO__DATA_TYPE__BFLOAT16 =
      16 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ONNX__TENSOR_PROTO__DATA_TYPE)
...
typedef enum _Onnx__TensorProto__DataLocation {
  ...
  ONNX__TENSOR_PROTO__DATA_LOCATION__EXTERNAL =
      1 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ONNX__TENSOR_PROTO__DATA_LOCATION)
} Onnx__TensorProto__DataLocation;
/*
 * Versioning
 * ONNX versioning is specified in docs/IR.md and elaborated on in
 * docs/Versioning.md To be compatible with both proto2 and proto3, we will use
 * a version number that is not defined by the default value but an explicit
 * enum number.
 */
typedef enum _Onnx__Version {
   ...
   */
  ONNX__VERSION__IR_VERSION =
      7 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ONNX__VERSION)
} Onnx__Version;
...
#define ONNX__ATTRIBUTE_PROTO__INIT                                            \
  {                                                                            \
    ...
    , (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string,        \
        ...
        ONNX__ATTRIBUTE_PROTO__ATTRIBUTE_TYPE__UNDEFINED, 0, 0, {0, NULL},     \
        NULL, NULL, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL \
  }
...
struct Onnx__TrainingInfoProto {
   ...
   * -> tensor_e Notice that an input of a node in the "algorithm" graph may
   * reference the output of a node in the inference graph (but not the other
   * way round). Also, inference node cannot reference inputs of "algorithm".
   * With these restrictions, inference graph can always be run independently
   * without training information. By default, this field is an empty graph and
   * its evaluation does not produce any output. Evaluating the default training
...
struct Onnx__TensorProto {
   ...
   * per tensor element (00000001 for true, 00000000 for false). Note: the
   * advantage of specific field rather than the raw_data field is that in some
   * cases (e.g. int data), protobuf does a better packing via variable length
   * storage, and may lead to smaller binary footprint. When this field is
   * present, the data_type field MUST NOT be STRING or UNDEFINED
   */
   ...
   * where the ONNX protobuf model was stored
   * - "offset" (optional) - position of byte at which stored data begins.
   * Integer stored as string. Offset values SHOULD be multiples 4096 (page
   * size) to enable mmap support.
  ...
  /*
   * If value not set, data is stored in raw_data (if set) otherwise in
...
#define ONNX__TENSOR_PROTO__INIT                                               \
  {                                                                            \
    ...
    , 0, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL,                    \
        (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string,      \
        {0, NULL}, 0, NULL, ONNX__TENSOR_PROTO__DATA_LOCATION__DEFAULT, 0,     \
        NULL, 0, NULL                                                          \
  }
...
typedef enum {
  ...
  ONNX__TENSOR_SHAPE_PROTO__DIMENSION__VALUE_DIM_PARAM =
      2 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(
          ONNX__TENSOR_SHAPE_PROTO__DIMENSION__VALUE__CASE)
...
#define ONNX__TENSOR_SHAPE_PROTO__DIMENSION__INIT                              \
  {                                                                            \
    ...
    , (char *)protobuf_c_empty_string,                                         \
        ONNX__TENSOR_SHAPE_PROTO__DIMENSION__VALUE__NOT_SET, {                 \
      0                                                                        \
    }                                                                          \
  }
...
typedef enum {
  ...
  ONNX__TYPE_PROTO__VALUE_MAP_TYPE =
      5 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ONNX__TYPE_PROTO__VALUE__CASE)
...
size_t
onnx__tensor_annotation__get_packed_size(const Onnx__TensorAnnotation *message);
...
size_t onnx__tensor_proto__pack(const Onnx__TensorProto *message, uint8_t *out);
...
typedef void (*Onnx__AttributeProto_Closure)(
    const Onnx__AttributeProto *message, void *closure_data);
typedef void (*Onnx__ValueInfoProto_Closure)(
    const Onnx__ValueInfoProto *message, void *closure_data);
typedef void (*Onnx__NodeProto_Closure)(const Onnx__NodeProto *message,
                                        void *closure_data);
typedef void (*Onnx__TrainingInfoProto_Closure)(
    const Onnx__TrainingInfoProto *message, void *closure_data);
typedef void (*Onnx__ModelProto_Closure)(const Onnx__ModelProto *message,
                                         void *closure_data);
typedef void (*Onnx__StringStringEntryProto_Closure)(
    const Onnx__StringStringEntryProto *message, void *closure_data);
typedef void (*Onnx__TensorAnnotation_Closure)(
    const Onnx__TensorAnnotation *message, void *closure_data);
typedef void (*Onnx__GraphProto_Closure)(const Onnx__GraphProto *message,
                                         void *closure_data);
typedef void (*Onnx__TensorProto__Segment_Closure)(
    const Onnx__TensorProto__Segment *message, void *closure_data);
typedef void (*Onnx__TensorProto_Closure)(const Onnx__TensorProto *message,
                                          void *closure_data);
typedef void (*Onnx__SparseTensorProto_Closure)(
    const Onnx__SparseTensorProto *message, void *closure_data);
typedef void (*Onnx__TensorShapeProto__Dimension_Closure)(
    const Onnx__TensorShapeProto__Dimension *message, void *closure_data);
typedef void (*Onnx__TensorShapeProto_Closure)(
    const Onnx__TensorShapeProto *message, void *closure_data);
typedef void (*Onnx__TypeProto__Tensor_Closure)(
    const Onnx__TypeProto__Tensor *message, void *closure_data);
typedef void (*Onnx__TypeProto__Sequence_Closure)(
    const Onnx__TypeProto__Sequence *message, void *closure_data);
typedef void (*Onnx__TypeProto__Map_Closure)(
    const Onnx__TypeProto__Map *message, void *closure_data);
typedef void (*Onnx__TypeProto_Closure)(const Onnx__TypeProto *message,
                                        void *closure_data);
typedef void (*Onnx__OperatorSetIdProto_Closure)(
    const Onnx__OperatorSetIdProto *message, void *closure_data);
